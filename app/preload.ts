...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  cancelMangaScan: () => ipcRenderer.invoke('manga:cancel-scan'),
  ...
  cancelBookScan: () => ipcRenderer.invoke('book:cancel-scan'),
  cancelAllScans: () => ipcRenderer.invoke('app:cancel-all-scans'),
  ...
  llmServerStatus: (modelId?: string) => ipcRenderer.invoke('llm-server:status', modelId),
  llmServerStart: (modelId?: string) => ipcRenderer.invoke('llm-server:start', modelId),
  llmServerStop: () => ipcRenderer.invoke('llm-server:stop'),
  llmModelsList: () => ipcRenderer.invoke('llm-models:list'),
  llmModelsGetActive: () => ipcRenderer.invoke('llm-models:get-active'),
  llmModelsSetActive: (modelId: string) => ipcRenderer.invoke('llm-models:set-active', modelId),
  llmModelsDownload: (modelId: string) => ipcRenderer.invoke('llm-models:download', modelId),
  llmModelsCancelDownload: (modelId: string) => ipcRenderer.invoke('llm-models:cancel-download', modelId),
  llmModelsDelete: (modelId: string) => ipcRenderer.invoke('llm-models:delete', modelId),
