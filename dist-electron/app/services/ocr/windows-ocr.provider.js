...
exports.WindowsOcrProvider = void 0;
...
`);
    ...
    runPs(script) {
        return new Promise((resolve, reject) => {
            ...
            const child = (0, child_process_1.spawn)('powershell.exe', ['-NoProfile', '-NonInteractive', '-EncodedCommand', encoded], { windowsHide: true });
            let out = '';
            let err = '';
            ...
            child.on('close', (code) => {
                if (code === 0)
                    ...
                    reject(new Error(err || out || `PowerShell exited ${code}`));
            });
        });
    }
}
exports.WindowsOcrProvider = WindowsOcrProvider;
